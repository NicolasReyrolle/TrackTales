...
#: Muted label for a field inside the modal.
MODAL_FIELD_LABEL_CLASSES = "text-sm text-gray-500 w-36"
...
#: Navigation counter label ("1 / 42") in the modal footer.
MODAL_NAV_COUNTER_CLASSES = "text-sm text-gray-500"
