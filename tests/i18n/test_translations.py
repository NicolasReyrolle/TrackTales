...
class TestTranslationFunction:
    ...
    def test_t_falls_back_to_english_when_lang_has_no_mo(self) -> None:
        ...
        with patch("i18n.core.get_language", return_value="xx"):  # non-existent language
            result = t("Language")
        assert result == "Language"
    ...
    def test_t_returns_unformatted_result_on_bad_format_string(
        ...
        with (
            ...
            patch("i18n.core._get_translation") as mock_trans,
        ):
    ...
    def test_t_never_returns_empty_string_for_known_msgids(self, lang: str) -> None:
        ...
        msgids = _read_msgids_from_pot()
        with patch("i18n.core.get_language", return_value=lang):
            for msgid in msgids:
                result = t(msgid)
...
"""
        ...
        with (
            patch("i18n.core._LOCALE_DIR", locale_dir),
            patch("i18n.core.get_language", return_value="zz"),
            patch("i18n.core.gettext.translation", side_effect=FileNotFoundError),
        ):
...
class TestTranslationModuleBranchCoverage:
    ...
    def test_compile_message_catalogs_logs_warning_when_catalog_compile_fails(
        ...
        with (
            patch("i18n.core._LOCALE_DIR", tmp_path),
            patch("i18n.core._compile_po_catalog", side_effect=RuntimeError("boom")),
    ...
    def test_translate_logs_warning_and_returns_unformatted_on_format_error(
        ...
        with (
            patch("i18n.core._get_translation") as mock_get_translation,
            caplog.at_level(logging.WARNING, logger="i18n"),
        ):
